...
class MerchantEditMenuPage extends StatelessWidget {
  const MerchantEditMenuPage({super.key});
      ...
      child: Column(
        ...
        children: [
         ...
         Text(
          ...
          CustomFilledButton(title: 'Update', width: double.infinity, onPressed: (){},),
          const SizedBox(height: 15,),
          CustomOutlineButton(title: 'Delete', width: double.infinity, onPressed: (){},)
        ],
      ),
    );
  }
